/**
 * Raydium CLMM swap math — sqrt-price math.
 *
 * Copied verbatim from Raydium SDK V2
 * (src/raydium/clmm/libraries/sqrtPriceMath.ts), Apache-2.0.
 * https://github.com/raydium-io/raydium-sdk-V2
 *
 * Only edit vs upstream: import of mulDiv helpers repointed to ./fixedPoint.
 */
import BN from "bn.js"
import { divRoundingUp, mulDivCeil, mulDivFloor } from "./fixedPoint"
import { BN_ONE, BN_ZERO, RESOLUTION } from "./constants"
