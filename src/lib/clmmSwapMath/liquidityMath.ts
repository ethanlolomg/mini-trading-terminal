/**
 * Raydium CLMM swap math — liquidity math.
 *
 * Copied verbatim from Raydium SDK V2
 * (src/raydium/clmm/libraries/liquidityMath.ts), Apache-2.0.
 * https://github.com/raydium-io/raydium-sdk-V2
 *
 * Only edit vs upstream: mulDiv helper imports repointed to ./fixedPoint.
 */
